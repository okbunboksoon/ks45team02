...
@Service
@Transactional
public class UserBoardUserGuideService {
	
	private static final Logger log = LoggerFactory.getLogger(UserBoardUserGuideService.class);

	private final BoardUserGuideMapper boardUserGuideMapper;
	
	public UserBoardUserGuideService(BoardUserGuideMapper boardUserGuideMapper) {
